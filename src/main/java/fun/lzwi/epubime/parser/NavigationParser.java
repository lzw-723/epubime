...
public class NavigationParser {
     ...
     */
    public List<EpubChapter> parseNcx(InputStream tocInputStream) throws java.io.IOException {
        String tocContent = XmlUtils.readStreamToString(tocInputStream);
     ...
     * @throws java.io.IOException IO异常
     */
    public List<EpubChapter> parseNav(InputStream navInputStream) throws java.io.IOException {
        String navContent = XmlUtils.readStreamToString(navInputStream);
     ...
     * @throws java.io.IOException IO异常
     */
    public List<EpubChapter> parseNavByType(InputStream navInputStream, String navType) throws java.io.IOException {
        String navContent = XmlUtils.readStreamToString(navInputStream);
